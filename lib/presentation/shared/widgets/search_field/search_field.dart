...
class SearchField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LightTextField(
      ...
      fieldName: fieldName,
      hintText: hintText,
      textStyle: LightTextStyles.nunitoS16W400(color: LightColors.text, height: 1.3),
      hintTextStyle: LightTextStyles.nunitoS16W400(color: LightColors.semiGrey, height: 1.3),
